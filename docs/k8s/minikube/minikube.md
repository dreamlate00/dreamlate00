...
--base-image='gcr.io/k8s-minikube/kicbase:v0.0.35@sha256:e6f9b2700841634f3b94907f9cfa6785ca4409ef8e428a0322c1781e809d311b':
    ...
    --driver='':
        Driver is one of: virtualbox, vmwarefusion, hyperv, vmware, qemu2 (experimental), docker, podman
...
--iso-url=[https://storage.googleapis.com/minikube/iso/minikube-v1.27.0-amd64.iso,https://github.com/kubernetes/minikube/releases/download/v1.27.0/minikube-v1.27.0-amd64.iso,https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/iso/minikube-v1.27.0-amd64.iso]:
    ...
    --kubernetes-version='':
        The Kubernetes version that the minikube VM will use (ex: v1.2.3, 'stable' for v1.25.2, 'latest' for v1.25.2).
        Defaults to 'stable'.
    ...
    --mount-string='C:\Users\1024:/minikube-host':
